...
public class CreareActivitateCurs extends JPanel {
    ...
    private final JLabel nrMaxStudL = new JLabel("Numar maxim de studenti:");
    ...
    public CreareActivitateCurs() {
        ...
        nrMaxStudL.setFont(new Font("TimesRoman", Font.BOLD, 20));
        ...
        gridPanel.add(nrMaxStudL);
        gridPanel.add(nrMaxStud);
    ...
    public int getNrMaxStud() {
        return Integer.parseInt(nrMaxStud.getText());
    }
